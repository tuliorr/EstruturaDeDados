...
1. `P01Listas/`
   ...
   Estruturas que permitem organizar elementos em posições. As versões em vetor
   favorecem acesso por índice; as versões encadeadas favorecem crescimento
   dinâmico e manipulação de referências.

2. `P02Pilhas/`

   Estruturas LIFO: o último elemento inserido é o primeiro removido. São úteis
   para chamadas de função, desfazer operações e validação de expressões.
...
4. `P04FilasPrioridade/`
   ...
   Estruturas em que a remoção depende da prioridade, não apenas da ordem de
   chegada. Mostram o impacto de manter os dados desordenados, ordenados ou em
   heap.
